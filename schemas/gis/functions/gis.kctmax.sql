...
--
-- Name: kctmax(text, text); Type: ACL; Schema: gis; Owner: pedro
--

REVOKE ALL ON FUNCTION kctmax(state text, p text) FROM PUBLIC;
REVOKE ALL ON FUNCTION kctmax(state text, p text) FROM pedro;
GRANT ALL ON FUNCTION kctmax(state text, p text) TO pedro;
GRANT ALL ON FUNCTION kctmax(state text, p text) TO PUBLIC;
