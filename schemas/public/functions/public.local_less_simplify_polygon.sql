...
--
-- Name: local_less_simplify_polygon(geometry); Type: FUNCTION; Schema: public; Owner: marian
--

CREATE FUNCTION local_less_simplify_polygon(v_geom geometry) RETURNS geometry
...
select 
((st_dumppoints(v_geom)).geom) as geom
...
ALTER FUNCTION public.local_less_simplify_polygon(v_geom geometry) OWNER TO marian;
