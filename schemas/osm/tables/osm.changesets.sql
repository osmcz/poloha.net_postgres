...
--
-- Name: changesets; Type: TABLE; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: changesets_pkey; Type: CONSTRAINT; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: changesets_created_at_idx; Type: INDEX; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: changesets_user_id_created_at_idx; Type: INDEX; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: changesets_user_id_id_idx; Type: INDEX; Schema: osm; Owner: osm; Tablespace: 
--
...
REVOKE ALL ON TABLE changesets FROM osm;
GRANT ALL ON TABLE changesets TO osm;
