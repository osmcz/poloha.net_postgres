...
--
-- Name: unearest_osm_address6(bigint); Type: FUNCTION; Schema: import; Owner: import
--

CREATE FUNCTION unearest_osm_address6(v_id bigint) RETURNS osmid
...
select into v_co,v_osmid co,id from
    ...
    (substring(provisionalnumber from '[0-9]+') = v_cislo_evidencni::text) or 
...
ALTER FUNCTION import.unearest_osm_address6(v_id bigint) OWNER TO import;
