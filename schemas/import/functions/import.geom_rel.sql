...
REVOKE ALL ON FUNCTION geom_rel(id bigint) FROM PUBLIC;
REVOKE ALL ON FUNCTION geom_rel(id bigint) FROM import;
GRANT ALL ON FUNCTION geom_rel(id bigint) TO import;
GRANT ALL ON FUNCTION geom_rel(id bigint) TO PUBLIC;
