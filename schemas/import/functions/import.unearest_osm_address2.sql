...
--
-- Name: unearest_osm_address2(bigint); Type: FUNCTION; Schema: import; Owner: import
--

CREATE FUNCTION unearest_osm_address2(v_id bigint) RETURNS osmid
...
-- 2.) nyni to same bez ohledu na nazev ulice (ulice alespon v 1 tab musi byt NULL), ale s ohledem na cislo orientacni
select into v_co,v_osmid co,id from
    ...
    (street is NULL or v_ulice is NULL) 
    )
...
ALTER FUNCTION import.unearest_osm_address2(v_id bigint) OWNER TO import;
