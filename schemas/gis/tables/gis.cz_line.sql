...
--
-- Name: cz_line; Type: TABLE; Schema: gis; Owner: mapnik
--
...
--
-- Name: cz_line_index; Type: INDEX; Schema: gis; Owner: mapnik
--

CREATE INDEX cz_line_index ON cz_line USING gist (way);

ALTER TABLE cz_line CLUSTER ON cz_line_index;


--
-- Name: cz_line_pkey; Type: INDEX; Schema: gis; Owner: mapnik
--
