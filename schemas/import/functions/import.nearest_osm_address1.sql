...
--
-- Name: nearest_osm_address1(bigint); Type: FUNCTION; Schema: import; Owner: import
--

CREATE FUNCTION nearest_osm_address1(v_id bigint) RETURNS osmid
...
alternatenumber = v_cislo_popisne::text or substring(alternatenumber from '[0-9]+') = v_cislo_evidencni::text) and 
    ...
    and distance_meters(geom,v_ruiangeom) < v_maxdistance
    and not isphysical(co,id)
...
ALTER FUNCTION import.nearest_osm_address1(v_id bigint) OWNER TO import;
