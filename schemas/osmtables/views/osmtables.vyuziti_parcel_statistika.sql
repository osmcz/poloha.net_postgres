...
REVOKE ALL ON TABLE vyuziti_parcel_statistika FROM PUBLIC;
REVOKE ALL ON TABLE vyuziti_parcel_statistika FROM pedro;
GRANT ALL ON TABLE vyuziti_parcel_statistika TO pedro;
