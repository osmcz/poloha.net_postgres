...
--
-- Name: gpx_files; Type: TABLE; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: gpx_files_pkey; Type: CONSTRAINT; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: gpx_files_timestamp_idx; Type: INDEX; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: gpx_files_user_id_idx; Type: INDEX; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: gpx_files_visible_visibility_idx; Type: INDEX; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: gpx_files_user_id_fkey; Type: FK CONSTRAINT; Schema: osm; Owner: osm
--
...
REVOKE ALL ON TABLE gpx_files FROM osm;
GRANT ALL ON TABLE gpx_files TO osm;
