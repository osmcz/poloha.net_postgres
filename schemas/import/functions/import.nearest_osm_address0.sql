...
--
-- Name: nearest_osm_address0(bigint); Type: FUNCTION; Schema: import; Owner: import
--

CREATE FUNCTION nearest_osm_address0(v_id bigint) RETURNS osmid
...
select into v_co,v_osmid co,id from
    ...
    and 
    distance_meters(geom,v_ruiangeom) < v_maxdistance
...
ALTER FUNCTION import.nearest_osm_address0(v_id bigint) OWNER TO import;
