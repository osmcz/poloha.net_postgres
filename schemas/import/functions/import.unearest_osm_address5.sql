...
--
-- Name: unearest_osm_address5(bigint); Type: FUNCTION; Schema: import; Owner: import
--

CREATE FUNCTION unearest_osm_address5(v_id bigint) RETURNS osmid
...
ALTER FUNCTION import.unearest_osm_address5(v_id bigint) OWNER TO import;
