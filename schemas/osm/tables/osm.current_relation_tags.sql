...
--
-- Name: current_relation_tags; Type: TABLE; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: current_relation_tags_pkey; Type: CONSTRAINT; Schema: osm; Owner: osm; Tablespace: 
--
...
--
-- Name: current_relation_tags_id_fkey; Type: FK CONSTRAINT; Schema: osm; Owner: osm
--
...
REVOKE ALL ON TABLE current_relation_tags FROM PUBLIC;
REVOKE ALL ON TABLE current_relation_tags FROM osm;
GRANT ALL ON TABLE current_relation_tags TO osm;
