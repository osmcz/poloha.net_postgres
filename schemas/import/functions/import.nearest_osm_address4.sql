...
--
-- Name: nearest_osm_address4(bigint); Type: FUNCTION; Schema: import; Owner: import
--

CREATE FUNCTION nearest_osm_address4(v_id bigint) RETURNS osmid
...
ALTER FUNCTION import.nearest_osm_address4(v_id bigint) OWNER TO import;
