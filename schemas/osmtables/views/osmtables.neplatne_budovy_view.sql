...
REVOKE ALL ON TABLE neplatne_budovy_view FROM PUBLIC;
REVOKE ALL ON TABLE neplatne_budovy_view FROM pedro;
GRANT ALL ON TABLE neplatne_budovy_view TO pedro;
